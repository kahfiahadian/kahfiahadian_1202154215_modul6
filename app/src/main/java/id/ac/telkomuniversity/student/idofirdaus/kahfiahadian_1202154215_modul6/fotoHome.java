...
public class fotoHome extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_foto_home);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                //Intent dari fotoHome ke PostActivity
                Intent intent = new Intent(fotoHome.this,PostActivity.class);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if(item.getItemId()==R.id.action_settings) {
            ...
            auth.signOut();
            //Intent dari fotoHome ke MenuLogin
            startActivity(new Intent(fotoHome.this, MenuLogin.class));
            //finish
            finish();
        }
